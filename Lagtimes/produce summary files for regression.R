...
load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2014/hse2014ai.RData"))
HSE2014original <- setDT(clear.labels(HSE2014original))
setnames(HSE2014original, c("age90", "origin3"), c("age", "origin"))
agegroup.fn(HSE2014original)


HSE2014 = copy(HSE2014original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval12, omsysval, diabtotr, cigst1, startsmk, endsmoke, numsmok, smokyrs, cigdyal,  origin, hdlval12, bpmedd2, diabete2, sha, porftvg, frtpor, sodiumval, potass, creatin, wt.urine)])
setnames(HSE2014, "sodiumval", "sodium")
HSE2014[, `:=`(year = 3, a30to06 = NA)]
HSE2014[, psu := paste0(psu, "2014")]
HSE2014[, cluster := paste0(cluster, "2014")]
setnames(HSE2014, c("cholval12", "hdlval12", "bpmedd2"), c("cholval1", "hdlval1", "bpmedd"))
HSE2014[, sha := as.integer(sha)]

load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2013/hse2013ai.RData"))
HSE2013original <- setDT(clear.labels(HSE2013original))
agegroup.fn(HSE2013original)


HSE2013 = copy(HSE2013original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval12, omsysval, diabtotr, cigst1, startsmk, endsmoke, numsmok, smokyrs, cigdyal,  origin, hdlval12, bpmedd2, diabete2, sha, porftvg, frtpor)])
HSE2013[, `:=`(year = 2, a30to06 = NA, sodiumval = NA, potass = NA, creatin = NA, 
               wt.urine = NA)]
HSE2013[, psu := paste0(psu, "2013")]
HSE2013[, cluster := paste0(cluster, "2013")]
setnames(HSE2013, c("cholval12", "hdlval12", "bpmedd2"), c("cholval1", "hdlval1", "bpmedd"))

HSE2013[, length(unique(psu)), by=cluster][, table(V1)] # stratas can have many psus
HSE2013[, length(unique(cluster)), by=psu][, table(V1)] # one psu has 2 stratas
HSE2013[, length(unique(cluster)), by=psu][V1==2, ] #21310152013
HSE2013[psu==21310152013 , cluster]
HSE2013[cluster==2132352013, psu]
HSE2013[psu==21310152013 & cluster==2132352013, psu := "21313402013"]
HSE2013[, sha := as.integer(sha)]

load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2012/hse2012ai.RData"))
...
HSE2012 = copy(HSE2012original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval12, omsysval, diabtotr, cigst1, startsmk, endsmoke, numsmok, smokyrs, cigdyal, a30to06, sodiumval, potass, creatin, wt.urine, origin, hdlval12, bpmedd2, diabete2, sha)])
...
load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2010/hse10ai.RData"))
HSE2010original <- setDT(clear.labels(HSE2010original))
HSE2010original <- HSE2010original[samptype==1]
...
HSE2010 =copy(HSE2010original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval1, omsysval, diabtotr, cigst1, startsmk, endsmoke, porftvg, frtpor, numsmok, smokyrs, cigdyal, sodival, potass, creatin, wt.urine, origin, hdlval1, kidfailgp, bpmedd, diabete2, sha)])
...
HSE2010[, sha := as.integer(sha)]

load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2009/hse09ai.RData"))
HSE2009original <- setDT(clear.labels(HSE2009original))
HSE2009original <- HSE2009original[samptype == 1]
...
HSE2009 =copy(HSE2009original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval1, omsysval, diabtotr, cigst1, startsmk, endsmoke, porftvg, frtpor, numsmok, smokyrs, cigdyal, sodium, potass, creatin, wt.urine, origin, hdlval1, bpmedd, diabete2, sha)])
HSE2009[, `:=`(year=-2, a30to06 = NA)]
HSE2009[, psu := paste0(psu, "2009")]
HSE2009[, cluster := paste0(cluster, "2009")]
HSE2009[, sha := as.integer(sha)]

load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2008/hse08ai.RData"))
HSE2008original <- setDT(clear.labels(HSE2008original))
HSE2008original <- HSE2008original[samptype == 1] 
...
load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2007/hse07ai.RData"))
HSE2007original <- setDT(clear.labels(HSE2007original))
HSE2007original <- HSE2007original[samptype == 1]
setnames(HSE2007original, c("imd2007", "area", "newsha"), c("qimd", "psu", "sha"))
...
HSE2007 = copy(HSE2007original[, list(wt.int, wt.nurse,  psu, cluster, age, agegroup, sex, group, qimd, bmival, omsysval, cigst1, startsmk, endsmoke, porftvg, frtpor, numsmok, smokyrs, cigdyal, sodium, potass, creatin, bpmedd, sha)])
...
load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2006/hse06ai.RData"))
HSE <- setDT(clear.labels(HSE))
HSE2006original <- HSE[samptype != 3]
rm(HSE)
...
HSE2006 = copy(HSE2006original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval1, omsysval, diabtotr, cigst1, startsmk, endsmoke, porftvg, frtpor, numsmok, smokyrs, cigdyal, a30to06, sodium, potass, creatin, famcvd, hdlval1, bpmedd, diabete2, sha)])
HSE2006[, `:=`(year = -5, wt.urine = wt.nurse)]
HSE2006[, psu := paste0(psu, "2006")]
HSE2006[, cluster := paste0(cluster, "2006")]

load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2005/hse05ai.RData")) # Only individuals aged 65 and over were asked for a blood sample
HSE2005original <- setDT(clear.labels(HSE2005original))
HSE2005original <- HSE2005original[samptype == 1] 
setnames(HSE2005original, c("imd2004", "area", "wt.bldel", "newsha"), c("qimd", "psu", "wt.blood", "sha"))
...
HSE2005 =copy(HSE2005original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval1, omsysval, diabtotr, cigst1, startsmk, endsmoke, porftvg, frtpor, numsmok, smokyrs, cigdyal, sodium, potass,
                                     creatin, hdlval1, bpmedd, diabete2, sha)])
HSE2005[, `:=`(year=-6, a30to06 = NA, wt.urine = wt.nurse)]
HSE2005[, psu := paste0(psu, "2005")]
HSE2005[, cluster := paste0(cluster, "2005")]
# match old SHA with new
HSE2005[sha %in% c("Q09", "Q10"), newsha := 1]
HSE2005[sha %in% c("Q13", "Q14", "Q15"), newsha := 2]
HSE2005[sha %in% c("Q11", "Q12", "Q23"), newsha := 3]
HSE2005[sha %in% c("Q24", "Q25"), newsha := 4]
HSE2005[sha %in% c("Q26", "Q27", "Q28"), newsha := 5]
HSE2005[sha %in% c("Q01", "Q02", "Q03"), newsha := 6]
HSE2005[sha %in% c("Q04", "Q05", "Q06", "Q07", "Q08"), newsha := 7]
HSE2005[sha %in% c("Q18", "Q19"), newsha := 8]
HSE2005[sha %in% c("Q16", "Q17"), newsha := 9]
HSE2005[sha %in% c("Q21", "Q22", "Q20"), newsha := 10]
HSE2005[, sha := as.integer(newsha)]

load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2004/hse04gpa.RData")) # It seems to be a mess with the weighting for the core and boost sample
HSE2004original <- setDT(clear.labels(HSE2004original))
HSE2004original <- HSE2004original[samptype == 7]
...
# match old SHA with new
HSE2004original[sha %in% c("Q09", "Q10"), newsha := 1]
HSE2004original[sha %in% c("Q13", "Q14", "Q15"), newsha := 2]
HSE2004original[sha %in% c("Q11", "Q12", "Q23"), newsha := 3]
HSE2004original[sha %in% c("Q24", "Q25"), newsha := 4]
HSE2004original[sha %in% c("Q26", "Q27", "Q28"), newsha := 5]
HSE2004original[sha %in% c("Q01", "Q02", "Q03"), newsha := 6]
HSE2004original[sha %in% c("Q04", "Q05", "Q06", "Q07", "Q08"), newsha := 7]
HSE2004original[sha %in% c("Q18", "Q19"), newsha := 8]
HSE2004original[sha %in% c("Q16", "Q17"), newsha := 9]
HSE2004original[sha %in% c("Q21", "Q22", "Q20"), newsha := 10]
HSE2004original[, sha := as.integer(newsha)]
...
HSE2004 =copy(HSE2004original[, list(wt.int, wt.nurse, wt.blood, psu, cluster, age, agegroup, sex, group, qimd, bmival, cholval1, omsysval, diabtotr, cigst1, startsmk, endsmoke, porftvg, frtpor, numsmok, smokyrs, cigdyal, adtot30, sodium,
                                     potass, creatin, hdlval1, bpmedd, diabete2, sha)])
...
load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2003/hse03ai.RData"))
...
# match old SHA with new
HSE2003original[sha %in% c("Q09", "Q10"), newsha := 1]
HSE2003original[sha %in% c("Q13", "Q14", "Q15"), newsha := 2]
HSE2003original[sha %in% c("Q11", "Q12", "Q23"), newsha := 3]
HSE2003original[sha %in% c("Q24", "Q25"), newsha := 4]
HSE2003original[sha %in% c("Q26", "Q27", "Q28"), newsha := 5]
HSE2003original[sha %in% c("Q01", "Q02", "Q03"), newsha := 6]
HSE2003original[sha %in% c("Q04", "Q05", "Q06", "Q07", "Q08"), newsha := 7]
HSE2003original[sha %in% c("Q18", "Q19"), newsha := 8]
HSE2003original[sha %in% c("Q16", "Q17"), newsha := 9]
HSE2003original[sha %in% c("Q21", "Q22", "Q20"), newsha := 10]
HSE2003original[, sha := as.integer(newsha)]
...
load(file = paste0(get.dropbox.folder(), "/Datasets/Health Survey for England/2002/hse02ai.RData"))
...
# match old SHA with new
HSE2002original[sha %in% c("Q09", "Q10"), newsha := 1]
HSE2002original[sha %in% c("Q13", "Q14", "Q15"), newsha := 2]
HSE2002original[sha %in% c("Q11", "Q12", "Q23"), newsha := 3]
HSE2002original[sha %in% c("Q24", "Q25"), newsha := 4]
HSE2002original[sha %in% c("Q26", "Q27", "Q28"), newsha := 5]
HSE2002original[sha %in% c("Q01", "Q02", "Q03"), newsha := 6]
HSE2002original[sha %in% c("Q04", "Q05", "Q06", "Q07", "Q08"), newsha := 7]
HSE2002original[sha %in% c("Q18", "Q19"), newsha := 8]
HSE2002original[sha %in% c("Q16", "Q17"), newsha := 9]
HSE2002original[sha %in% c("Q21", "Q22", "Q20"), newsha := 10]
HSE2002original[, sha := as.integer(newsha)]

HSE2002 = copy(HSE2002original[, list(wt.int, wt.nurse, wt.blood, wt.urine, psu, cluster, age, agegroup, sex, group, qimd, bmival, omsysval, cigst1, startsmk, endsmoke, porftvg, frtpor, numsmok, smokyrs, cigdyal, a30to06, bpmedd, sha)])
...
HSE.ts <- rbind(HSE2014, HSE2013, HSE2012, HSE2011, HSE2010, HSE2009, HSE2008, HSE2007, HSE2006, HSE2005, HSE2004, HSE2003, HSE2002, 
                fill = T)
...
A = copy(HSE.ts[is.na(a30to06m) == T & age >15 & is.na(agegroup)==F & is.na(sex)==F & is.na(qimd)==F, .(id, agegroup, sex, qimd, year_ch, wt.int, psu, cluster)]) # missing pa to be imputed

B = copy(HSE.ts[age >15 & is.na(a30to06m)==F & is.na(agegroup)==F & is.na(sex)==F & is.na(qimd)==F, .(id, a30to06m, agegroup, sex, year_ch, qimd, wt.int, psu, cluster)]) # 
...
ttt <- melt(ttt, id=c("id", "agegroup", "sex", "qimd", "year_ch", "wt.int", "psu", "cluster"), variable.name = "a30to06m.imp")
setkey(ttt, id, value)
ttt[value < 0, value := 0 ]
ttt[value > 1, value := 1 ]
...
A = copy(HSE.ts[is.na(porftvg)==T & age >15 & is.na(agegroup)==F & is.na(sex)==F & is.na(qimd)==F & year == 1, .(id, agegroup, sex, qimd, wt.int, psu, cluster)])
...
HSE.ts.srv.blood <- subset(HSE.ts.srv.blood, age>19 & wt.blood>0 & is.na(cholval1)== F & is.na(qimd)== F & is.na(bmival)== F & is.na(a30to06m.imp)==F & is.na(porftvg.imp)==F) # 
dt <- subset(HSE.ts, age>19 & wt.nurse > 0 &
...
HSE.ts.srv.blood <- svydesign(id=~psu, strata =~cluster, weights = ~wt.blood, nest=F, data=HSE.ts, check.strata = T)
HSE.ts.srv.blood <- subset(HSE.ts.srv.blood, age>19 & wt.blood>0 & is.na(diabtotr)== F & is.na(qimd)== F & is.na(bmival)== F & is.na(a30to06m.imp)== F) # 
...
setkey(HSE.nat, age)
setkey(HSE.ts, age)
HSE.ts[,wt.int := wt.int*1000/sum(wt.int), by = year] # make pop of each hse =1000
...
HSE.ts[age > 85, age := 85]
HSE.ts.srv.int <- svydesign(id=~psu, strata =~cluster, weights = ~wt.int, nest=F, data=HSE.ts, check.strata = T)
HSE.ts.srv.int <- subset(HSE.ts.srv.int, age>15 & wt.int>0 & is.na(qimd)==F & is.na(smok.cess)==F)
...
HSE.ts[age>85, age := 85]
HSE.ts.srv.int <- svydesign(id=~psu, strata =~cluster, weights = ~wt.int, nest=F, data=HSE.ts, check.strata = T)
HSE.ts.srv.int <- subset(HSE.ts.srv.int, age>15 & age <21 & wt.int>0 & !is.na(qimd) & !is.na(smok.active))
...
tt = copy(HSE.ts[age>19 & wt.int>0 & is.na(porftvg)== F & is.na(qimd)==F])
...
HSE.ts[, agegroup := agegroup.fn(age)]
HSE.ts.srv.int <- svydesign(id=~psu, strata =~cluster, weights = ~wt.int, nest=F, data=HSE.ts, check.strata = T)
HSE.ts.srv.int <- subset(HSE.ts.srv.int, wt.int>0 & !is.na(kidfailgp) & omsysval > 0) 
...
HSE.ts.srv.int <- svydesign(id=~psu, strata =~cluster, weights = ~wt.int, 
                            nest=F, data=HSE.ts, check.strata = T)
HSE.ts.srv.int <- subset(HSE.ts.srv.int, age > 15 & age < 85 & wt.int > 0 &
                           !is.na(smokyrs) &
                           !is.na(qimd) & !is.na(cigdyalCat) & cigst1 == 4)
tt = copy(HSE.ts[between(age, 16, 84) & wt.int > 0 &
...
ttt <- data.frame(cigdyalCat=tt[,cigdyalCat],scale(tt[,.(year, age, smokyrs)]), tt[,.(sex,qimd,wt.int)]) 
