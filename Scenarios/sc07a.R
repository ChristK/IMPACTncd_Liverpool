...
set(POP, NULL, "eligible_sc07a", 0L)
...
set(POP, NULL, "invited_sc07a", 0L)
set(POP, NULL, "dice_coverage",  dice(nrow(POP)))
setkey(POP, id, year) # Do not remove
POP[eligible_sc07a == 1 & year >= intervention_year, 
    invited_sc07a := HC_coverage(id, coverage, dice_coverage)]

# Estimate uptake
set(POP, NULL, "participated_sc07a", 0L)
...
POP[invited_sc07a == 1, uptake := fcompress(uptake, .N * hc_annual_uptake), by=year]# Compress weights to givel reach uptake level
POP[invited_sc07a == 1, participated_sc07a := rbinom(.N, 1, uptake)]
...
POP[participated_sc07a  == 1,  statins_uptake :=
...
POP[participated_sc07a  == 1 & cholval >= 5,
...
POP[participated_sc07a  == 1,  antihtn_uptake := bound(prescription_uptake * .N / count_if(omsysval >= 135)), by = .(qimd, qrisk_grp)] # adjust weights to reflect only those with high SBP
POP[participated_sc07a  == 1 & omsysval >= 135,
...
set(POP, NULL, "statins_prescribed_sc07a", 0L)
POP[participated_sc07a  == 1 & cholval >= 5,  statins_prescribed_sc07a := rbinom(.N, 1, statins_uptake)]
set(POP, NULL, "statins_taken_sc07a", 0L)
POP[statins_prescribed_sc07a  == 1,  statins_taken_sc07a := rbinom(.N, 1, persistence.mc)]

set(POP, NULL, "antihtn_prescribed_sc07a", 0L)
POP[participated_sc07a  == 1 & omsysval >= 135,  antihtn_prescribed_sc07a := rbinom(.N, 1, antihtn_uptake)]
set(POP, NULL, "antihtn_taken_sc07a", 0L)
POP[antihtn_prescribed_sc07a  == 1,  antihtn_taken_sc07a := rbinom(.N, 1, persistence.mc)]

set(POP, NULL, "participation_effect_sc07a", 0L)
setkey(POP, id, year) # Do not remove
POP[, participation_effect_sc07a := HC_effect(id, participated_sc07a, invited_sc07a)] # Effect lasts until next invitation
POP[, statins_taken_sc07a := med_effect(id, statins_taken_sc07a, participation_effect_sc07a)] # Effect lasts until next invitation
POP[, antihtn_taken_sc07a := med_effect(id, antihtn_taken_sc07a, participation_effect_sc07a)] # Effect lasts until next invitation
#View(POP[year >= intervention_year& eligible_sc07a == 1, .(id, year, invited_sc07a, participated_sc07a, participation_effect_sc07a, statins_prescribed_sc07a, statins_taken_sc07a)])

# Estimate effect
#cholesterol
POP[, cholval_sc07a := cholval]
POP[statins_taken_sc07a  == 1,  cholval_sc07a := cholval * (1 - atorv.eff.mc * adherence.mc)]
setkey(POP, id, year) # Do not remove
POP[, cholval.cvdlag := shift_byid(cholval_sc07a, cvd.lag.mc, 3.8, id)] # lag exposure
#SBP
POP[, omsysval_sc07a := omsysval]
POP[antihtn_taken_sc07a  == 1,  omsysval_sc07a := omsysval - (omsysval - 135) * adherence.mc] # Assume that antihtn medication can potentialy achieve sbp 135 for all
POP[(omsysval - omsysval_sc07a)<0, omsysval_sc07a := omsysval]
setkey(POP, id, year) # Do not remove
POP[, omsysval.cvdlag := shift_byid(omsysval_sc07a, cvd.lag.mc, 115, id)] # lag exposure

# Behavioural change
set(POP, NULL, "behavioural_effect_sc07a", 0L)
POP[participated_sc07a == 1 & 
      qrisk_grp %in% c("qrisk10to20", "qrisk20+") & 
      year >= intervention_year2,
    behavioural_effect_sc07a := rbinom(.N, 1, 0.5)]
setkey(POP, id, year) # Do not remove
POP[, behavioural_effect_sc07a := med_effect(id, behavioural_effect_sc07a, participation_effect_sc07a)] # Effect lasts until next invitation
#View(POP[year >= intervention_year2 & eligible_sc07a == 1 & qrisk_grp %in% c("qrisk10to20", "qrisk20+"), .(id, year, invited_sc07a, participated_sc07a, participation_effect_sc07a, behavioural_effect_sc07a)])

# 50% of middle and high-risk participants (QRISK > 10) increase their F&V consumption by 1 portion
POP[, porftvg_sc07a := porftvg]
POP[behavioural_effect_sc07a == 1L, porftvg_sc07a := porftvg + 1L]
POP[, porftvg.cvdlag := shift_byid(porftvg_sc07a, cvd.lag.mc, 0, id)] # lag exposure

# 50% of middle and high-risk participants (QRISK > 10) increase their PA by 1 active day per week
POP[, a30to06m_sc07a := a30to06m]
POP[behavioural_effect_sc07a == 1L, a30to06m_sc07a := a30to06m + 1L]
POP[, a30to06m.cvdlag := shift_byid(a30to06m_sc07a, cvd.lag.mc, 0, id)] # lag exposure
...
setkey(POP, id, year) # Do not remove
POP[, bmival_sc07a := bariatricsurg_effect(id, bmival, behavioural_effect_sc07a, participated_sc07a)] #also copy bmival for those not affected
POP[behavioural_effect_sc07a == 1L, bmival_sc07a := 0.99 * bmival]
POP[, bmival.cvdlag := shift_byid(bmival_sc07a, cvd.lag.mc, 20, id)] # lag exposure
...
POP[participated_sc07a == 1 & 
      year >= intervention_year2 &
      cigst1 == "4",
    behavioural_effect_sc07a := rbinom(.N, 1, 0.1)]
setkey(POP, id, year) # Do not remove
POP[, behavioural_effect_sc07a := med_effect(id, behavioural_effect_sc07a, participation_effect_sc07a)] # 
POP[, cigst1_sc07a := smokclinic_effect(id, cigst1, behavioural_effect_sc07a, participated_sc07a)] # also copy cigst1 to cigst1_sc07a
# TODO alter endsmok, numsmoke, cigst1 etc... when people quit smoking
POP[, cigst1_sc07a := factor_(cigst1_sc07a, 1:4)]
POP[cigst1_sc07a == "3", smoke_cat := 1L]
POP[, cigst1.cvdlag := shift_byid(cigst1_sc07a, cvd.lag.mc, 1L, id, 1:4)] # lag exposure

#recalculate diabetes prob
# Diab probabilities
POP[, bpmed := bpmed_init] #reset for each scenario. not needed for sc07a. Here for consistency
POP[antihtn_taken_sc07a == 1L, bpmed := 1L] # feedback loop. Antihtn meds increased prescription increases diab 
...
set(POP, NULL, "htn.incidence_sc07a", 0L)
POP[omsysval_sc07a > 135 | bpmed == 1, htn.incidence_sc07a := 6000L]
...
# Calculate incidence
setkey(POP, id, year)
POP[, diabtotr_sc07a := diabtotr_init]
set(POP, NULL, "chd.incidence_sc07a", 0L)
set(POP, NULL, "stroke.incidence_sc07a", 0L)
POP[year >= 0, c("diabtotr_sc07a", "chd.incidence_sc07a", "stroke.incidence_sc07a") :=
...
POP[, diabtotr_sc07a := factor_(diabtotr_sc07a)]

# Calculate mortality
set(POP, NULL, "death.tob.rr", 1)
POP[cigst1.cvdlag == "4", death.tob.rr := smokriskofdeath]
set(POP, NULL, "death.diab.rr", 1)
POP[, diabtotr.cvdlag := shift_byid(diabtotr_sc07a, cvd.lag.mc, 1L, id, 1:2)] # lag exposure
...
POP[, `:=` (chd.mortality_sc07a = 0L,
            stroke.mortality_sc07a = 0L,
            other.mortality_sc07a = 0L)]
setkey(POP, id, year)
POP[year >= 0 & chd.incidence_sc07a > 0,
    chd.mortality_sc07a := mortality_events(pr_chd_death, dice_chd_death, id, -20L)]
POP[year >= 0 & stroke.incidence_sc07a > 0,
    stroke.mortality_sc07a := mortality_events(pr_stroke_death, dice_stroke_death,
                                             id, -3L)]
POP[year >= 0,
    other.mortality_sc07a := mortality_events(pr_other_death, dice_other_death,
                                            id, -100L)]
...
fwrite_safe(summary_RF_fn(RF, nam, "sc07a"),         output.dir("sc_RF.csv"),      append = TRUE)
fwrite_safe(summary_RF_fn(RF, nam, "sc07a", "qimd"), output.dir("sc_RF_qimd.csv"), append = TRUE)
fwrite_safe(summary_RF_fn(RF, nam, "sc07a", "sex"),  output.dir("sc_RF_sex.csv"),  append = TRUE)
fwrite_safe(summary_RF_fn(RF, nam, "sc07a", "age"),  output.dir("sc_RF_age.csv"),  append = TRUE)

# shape output
out <- mask_age(out)

fwrite_safe(summary_fn(out, nam, "sc07a"),         output.dir("sc_results.csv"),      append = TRUE)
fwrite_safe(summary_fn(out, nam, "sc07a", "qimd"), output.dir("sc_results_qimd.csv"), append = TRUE)
fwrite_safe(summary_fn(out, nam, "sc07a", "sex"),  output.dir("sc_results_sex.csv"),  append = TRUE)
fwrite_safe(summary_fn(out, nam, "sc07a", "age"),  output.dir("sc_results_age.csv"),  append = TRUE)

POP[, grep("_sc07a", names(POP), value = T) := NULL]
rm(out, nam, tt, x, RF)
